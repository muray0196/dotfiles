...
- Keep Zsh, Starship, Sheldon, zsh-abbr, Git, and Neovim in `shell`.
...
- `lib/`: Store shared implementation used by install, update, and doctor commands.
...
- At minimum, keep smoke coverage for shell syntax, TOML/JSON/Python syntax, profile-manifest-package-module-action references, all profile resolutions, and Ubuntu/Fedora/WSL dry-runs.
